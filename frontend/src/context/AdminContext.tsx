...
//   getUsersPaginated: (page: number, limit: number,searchQuery:string) => Promise<PaginationData>;
...
//   const getDoctorsPaginated = async (page: number, limit: number, searchQuery: string = ""): Promise<PaginationData> => {
//     try {
...
//   const getUsersPaginated = async (page: number, limit: number,searchQuery:string): Promise<PaginationData> => {
//     try {
