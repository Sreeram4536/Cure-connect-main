...
import { 
  getDoctorWalletBalanceAPI, 
  getDoctorWalletTransactionsAPI, 
  getDoctorWalletDetailsAPI 
} from "../../services/doctorWalletServices";
import { Wallet, ArrowUpRight, ArrowDownLeft, Calendar, Clock, TrendingUp, Users } from "lucide-react";
...
const DoctorWallet = () => {
  ...
  const fetchWalletDetails = async () => {
    try {
      const response = await getDoctorWalletDetailsAPI();
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Doctor Wallet</h1>
          <p className="text-gray-600">Manage your earnings and view revenue share transactions</p>
        </div>
          ...
          <div className="bg-gradient-to-r from-green-600 to-emerald-700 rounded-2xl p-6 mb-8 text-white shadow-lg">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-green-100">Total Transactions: {walletDetails.totalTransactions}</p>
              </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-blue-900">Revenue Share Information</h3>
