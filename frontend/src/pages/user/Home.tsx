...
const Home = () => {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-blue-50 via-indigo-50 to-purple-50"></div>
      
      {/* Dynamic Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Primary gradient orbs */}
        <div className="absolute top-10 left-5 w-96 h-96 bg-gradient-to-br from-blue-300/25 to-indigo-400/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-20 right-10 w-80 h-80 bg-gradient-to-br from-purple-300/20 to-pink-300/15 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1.5s'}}></div>
        <div className="absolute bottom-10 left-1/3 w-72 h-72 bg-gradient-to-br from-cyan-300/20 to-blue-300/15 rounded-full blur-3xl animate-pulse" style={{animationDelay: '3s'}}></div>
        
        {/* Secondary accent orbs */}
        <div className="absolute top-1/2 left-1/4 w-64 h-64 bg-gradient-to-br from-emerald-200/15 to-teal-300/10 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2.5s'}}></div>
        <div className="absolute bottom-1/3 right-1/4 w-56 h-56 bg-gradient-to-br from-orange-200/15 to-red-300/10 rounded-full blur-3xl animate-pulse" style={{animationDelay: '4s'}}></div>
        ...
        <div className="absolute bottom-1/4 left-1/2 w-4 h-4 bg-purple-400/30 rounded-full animate-bounce" style={{animationDelay: '1s'}}></div>
        ...
        {/* Geometric accents */}
        <div className="absolute top-1/3 right-1/4 w-16 h-16 border border-blue-300/20 rotate-45 animate-spin" style={{animationDuration: '30s'}}></div>
        <div className="absolute bottom-1/3 right-1/3 w-12 h-12 border border-indigo-300/25 rotate-12 animate-spin" style={{animationDuration: '25s', animationDirection: 'reverse'}}></div>
        <div className="absolute top-2/3 left-1/4 w-10 h-10 border border-purple-300/20 rotate-30 animate-spin" style={{animationDuration: '35s'}}></div>
      </div>
      ...
      <div className="relative z-10">
        ...
        {/* Speciality Menu Section - Just add background */}
        <div className="mb-10">
        ...
        {/* Top Doctors Section - Just add background */}
        <div className="mb-10">
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/30">
            <TopDoctors />
          </div>
        ...
        <div className="mb-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {/* Feature 1 */}
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-white/40 group hover:scale-105">
